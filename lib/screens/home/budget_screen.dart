...
//         ),
//         const SizedBox(height: 12),
//         // Орлого, зарлагын мэдээлэл
//         Row(
//           mainAxisAlignment: MainAxisAlignment.spaceBetween,
//           children: [
//             Text(
//               'Орлого: ₮${numberFormat.format(budget.income)}',
//               style: TextStyle(
//                 fontSize: 13,
//                 color: kIncomeColor,
//               ),
//             ),
//             Text(
//               'Зарлага: ₮${numberFormat.format(budget.expense)}',
//               style: TextStyle(
//                 fontSize: 13,
//                 color: kExpenseColor,
//               ),
...
//             children: [
//               Text(
//                 'Төсөв: ₮${numberFormat.format(budget.amount)}',
//                 style: const TextStyle(
//                   fontWeight: FontWeight.bold,
//                 ),
//               ),
...
//               const SizedBox(height: 4),
//               Text(
//                 'Үлдэгдэл: ₮${numberFormat.format(budget.remaining)}',
//                 style: TextStyle(
//                   fontWeight: FontWeight.bold,
//                   color: budget.isOverBudget ? kExpenseColor : kIncomeColor,
//                 ),
//               ),
//               const SizedBox(height: 12),
//               Text(
//                 'Хугацаа: ${_formatDate(budget.startDate)} - ${_formatDate(budget.endDate)}',
//               ),
//               const SizedBox(height: 16),
//               Row(
...
//                 children: [
//                   ElevatedButton.icon(
//                     onPressed: () => _showAddIncomeDialog(budget),
...
//                   ),
//                   ElevatedButton.icon(
//                     onPressed: () => _showAddExpenseDialog(budget),
...
//   void _showAddIncomeDialog(BudgetModel budget) {
//     final amountController = TextEditingController();
...
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     const SnackBar(content: Text('Дүн оруулна уу')),
//                   );
//                   return;
//                 }
...
//                 if (amount <= 0) {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     const SnackBar(content: Text('Дүн 0-ээс их байх ёстой')),
//                   );
//                   return;
//                 }

//                 // Орлого нэмэх
//                 final updatedBudget = budget.addIncome(amount);

//                 _budgetService.updateBudget(updatedBudget).then((_) {
//                   Navigator.pop(context); // Диалог хаах
//                   Navigator.pop(context); // Дэлгэрэнгүй диалог хаах
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(
//                       content: const Text('Орлого амжилттай нэмэгдлээ'),
...
//   void _showAddExpenseDialog(BudgetModel budget) {
//     final amountController = TextEditingController();
//     final descriptionController = TextEditingController();
...
//                 // Зарлага нэмэх
//                 final updatedBudget = budget.addExpense(amount);
...
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(
//                       content: const Text('Зарлага амжилттай нэмэгдлээ'),
//                       backgroundColor: Colors.green,
//                     ),
//                   );
//                 }).catchError((error) {
...
//     // Үлдэгдэл болон хэтрэлтийг шинэчилсэн логикоор тооцох
//     double remaining = budget.remaining;
//     bool isOverBudget = budget.isOverBudget;
//     double percentUsed = budget.percentUsed;
...
//                         ),
//                         decoration: BoxDecoration(
//                           color: _getTimeColor(budget.endDate).withOpacity(0.1),
//                           borderRadius: BorderRadius.circular(12),
//                         ),
//                         child: Text(
//                           _getRemainingDays(budget.endDate),
